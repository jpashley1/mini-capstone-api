...
class ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "create" do
    assert_difference "Product.count", 1 do
      post "/products.json", params: { name: "lake!!", price: 800, description: "it's very nice and it is a lake i guess"}
      assert_response 200
    end
  ...
  test "show" do
    ...
    data = JSON.parse(response.body)
    assert_equal ["id", "name", "price", "description", "created_at", "updated_at", "stock", "supplier_id"], data.keys
  end
